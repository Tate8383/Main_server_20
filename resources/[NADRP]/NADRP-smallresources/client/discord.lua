...
CreateThread(function()
	...
	SetDiscordAppId(922664865267601478)
	...
	SetDiscordRichPresenceAsset('816129720-bg-1')
        ...
        SetDiscordRichPresenceAssetText('Denali Roleplay')
        ...
        SetDiscordRichPresenceAction(0, "Join Denali RP", "https://discord.gg/xE9mpAVnpH")
